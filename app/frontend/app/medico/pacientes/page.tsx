...
import { useMedico } from '../../contexts/MedicoContext'; // Usamos el contexto para el filtro
    ...
    <div className="p-4 sm:p-6 md:p-8">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800">
          Mis Pacientes de <span className="text-blue-600">{activeSpecialty?.descripcion || '...'}</span>
        </h1>
      ...
      <main>
        ...
        {activeSpecialty && (
          <PatientList activeSpecialty={activeSpecialty.descripcion} />
        )}
      </main>
    </div>
  );
