...
from app.backend.schemas.especialidad import EspecialidadCreate, EspecialidadOut, EspecialidadUpdate
...
def actualizar_especialidad(especialidad_id: int, payload: EspecialidadUpdate, db: Session = Depends(get_db)):
