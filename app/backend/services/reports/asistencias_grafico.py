...
class ReporteGraficoAsistenciasStrategy(StrategyReports):
    ...
    def generate_report(
        ...
        stats_data = self.turno_repo.count_asistencia_vs_inasistencia(
            start_date, end_date
        )
        ...
        if total == 0:
            return {
                ...
                "data": [],
                "summary": {
                    "asistencia_porcentaje": "0.00%",
                    "inasistencia_porcentaje": "0.00%",
                    "mensaje": "No hay turnos finalizados o ausentes en el periodo.",
                },
            }
        ...
        asistencia = next(
            (
                ...
                if item["Tipo_Registro"] == "Finalizado"
            ),
            0,
        )
        inasistencia = next(
